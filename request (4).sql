...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2014 at 02:27 PM
...
`requestid` int(11) NOT NULL,
  `category` varchar(50) NOT NULL DEFAULT 'TBD',
...
('ankit ghosalkar', 'axg5348@rit.edu', '5852785955', '', '', 0x30, 0, 'United States', 1, 1000001, 'tbdddd', 0),
('Study', '', '', '', '', 0x30, 0, '', 3, 1000002, '', 0),
('ankit ghosalkar', 'axg5348@rit.edu', '5852785955', '', '', 0x30, 0, 'United States', 3, 1000003, 'TBD', 1),
('', '', '', '', '', 0x30, 0, '', 3, 1000004, 'TBD', 1);
...
--
ALTER TABLE `request`
MODIFY `requestid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1000005;
